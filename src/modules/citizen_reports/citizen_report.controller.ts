...
export const createCitizenReport = async (req: Request, res: Response): Promise<void> => {
...
export const listCitizenReports = async (req: Request, res: Response): Promise<void> => {
...
export const updateCitizenReportStatus = async (req: Request, res: Response): Promise<void> => {
  ...
  const result = await citizenReportsCollection().findOneAndUpdate(
    { _id: new ObjectId(id) },
...
export const deleteCitizenReport = async (req: Request, res: Response): Promise<void> => {
  const id = readParam(req.params.id);
