...
import { batchUpdateCategoryOrder, createCategory, deleteCategory, getCategoryById, getCategoryBySlug, listCategories, updateCategory } from './category.controller.js';
...
router.patch('/batch-order', validateToken, requireRole('admin'), batchUpdateCategoryOrder);
router.patch('/:id', validateToken, requireRole('admin'), validateParamsSchema(categoryIdSchema), validateBodySchema(updateCategorySchema), updateCategory);
